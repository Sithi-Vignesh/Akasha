...
def resume_generator(resume_chunks, company_name, job_description, fit_summary, gaps, suggestions, fit_score):
    resume_chunks_str = str(resume_chunks)
    gaps_str = str(gaps)
    ...
    template = r"""%-------------------------
        ...
        \end{document}
        """
    prompt = f"""You are the best resume generator and the Hiring manager of the company {company_name}.
            these are the current resume chunks of the candidate {resume_chunks_str}.
