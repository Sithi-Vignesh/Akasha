  ...
  return (
    <div className="relative w-full h-[100vh] flex flex-col items-center justify-center text-center p-6 z-10 pointer-events-none -translate-y-8">
      <div className="flex flex-col items-center gap-0">
        ...
        />
        <h1 className="font-display font-extrabold text-[clamp(2rem,5vw,4rem)] tracking-tight leading-tight -mt-15">
          Akasha
        </h1>
      </div>

      <p className="text-xl md:text-2xl text-[var(--text-secondary)] font-medium max-w-2xl mx-auto mt-6">
